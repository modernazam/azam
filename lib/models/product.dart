...
class ProductModel with ChangeNotifier {
  ...
  Future<List<Product>> fetchProductLayout(config) async {
    return await _service.fetchProductsLayout(config: config);
  }
  ...
  void getProductsList({categoryId, minPrice, maxPrice, orderBy, order, page}) async {
    try {
      if (categoryId != null) {
        this.categoryId = categoryId;
      }
  ...
  static showList({cateId, cateName, context, List<Product> products, config, noRouting}) {
    ...
    if (products != null) {
      ...
      return Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ProductsPage(products: products, categoryId: categoryId)));
    }
