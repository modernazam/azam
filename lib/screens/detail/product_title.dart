...
class ProductTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final regularPrice =
        productVariation != null ? productVariation.regularPrice : product.regularPrice;
    final onSale = productVariation != null ? productVariation.onSale : product.onSale;
    final price = productVariation != null ? productVariation.price : product.price;
