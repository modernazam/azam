  ...
  Widget _buildCart(BuildContext context, Widget child) {
    ...
    return Semantics(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Theme.of(context).backgroundColor, borderRadius: BorderRadius.only(topLeft: Radius.circular(25.0),),
        ),
        child: Material(
...
class _ProductThumbnailRowState extends State<ProductThumbnailRow> {
  ...
  Product _productWithId(String key) {
    ...
    final Product product =
        Provider.of<CartModel>(context).getProductById(productId);
    assert(product != null);
    return product;
  }
